...
## 设计中遇到的问题
首先是开发板是正面朝上还是反面朝上的问题（键盘正常使用时有按键的一面为正，上面），正面朝上将开发板的元件隐藏在开发板和键盘板之间，避免新手将开发板弄脏甚至脱焊短路，但是如果开发板有问题则不好排查，焊接过程中，我将开发板上粘了一层电工胶带与键盘板隔离可以一定程度上提高安全性；

反面朝上其实更好焊接，间隙也小，毕竟元件都在开发板的正面，可以紧贴着键盘板焊接，但是缺点前边也说过了，而且开发板背面有芯片烧录接口和充电电流调整跳线，有可能后期会调整；

正面还是反面焊接涉及到整个电路的设计，所以要构思清楚；

对元件供电不要用BAT+引脚，此引脚仅用来给电池充电，应该用RAW引脚对外供电，是稳定5V电压，
# ZMK编写
